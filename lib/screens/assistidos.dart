...
import 'package:trabalho1/logic/monitor_local_db_state.dart';
import 'package:trabalho1/model/collection/review_collection.dart';
...
class Assistidos extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MonitorBloc, MonitorState>(
      builder: (context, state) => getReviewListView(state.reviewCollection),);
      /*child: ListView(
        children: [
          ListTile(
  ...
  ListView getReviewListView(ReviewCollection reviewCollection){
    return ListView.builder(
      itemCount: reviewCollection.length(),
      itemBuilder: (context, position) => 
      ListTile(
        title: const Text("ACHAR UM JEITO DE PEGAR O NOME DO FILME"),
        subtitle: Text(reviewCollection.getReviewAtIndex(position).comment),
